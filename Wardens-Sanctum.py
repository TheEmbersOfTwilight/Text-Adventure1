...
print()
time.sleep(1)
type_text("You walk put the door and find yourself next to a tree in a dense forest, with a dilapidated stone building off in the distance")
print()
time.sleep(1)
...
print()
time.sleep(1)
type_text("You walk up to the flowers and inspect them closely")
print()
time.sleep(1)
...
if Razor == True:
    ...
    time.sleep(1)
    timewasted=True
type_text("You head back towards the stone building")
print()
time.sleep(1)
