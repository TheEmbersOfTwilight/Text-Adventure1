...
- Commit message style: short summary on the first line (50 chars or less), followed by an optional detailed description.
...
Please follow a professional and respectful tone in all conversations. Contributors must follow the `CODE_OF_CONDUCT.md`.
